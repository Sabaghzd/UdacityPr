...
#          is of-a-dog, otherwise the label isn't of a  # Reads in dognames from file, 1 name per line & audog. Alternatively one 
...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    # Reads in dognames from file, 1 name per line & auas infile:
